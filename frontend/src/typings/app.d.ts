...
declare namespace App {
    ...
    type Schema = {
      ...
      page: {
        ...
        analysis: {
          ...
          alertTitle: string;
          alertDrop: string;
          alertDropDesc: string;
          alertInteract: string;
          alertInteractDesc: string;
          alertLead: string;
          alertLeadDesc: string;
  ...
  namespace Service {
    /** Other baseURL key */
    type OtherBaseURLKey = 'demo' | 'backend';
